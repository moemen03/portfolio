  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (isVisibleRef.current) {
        material.uniforms.uTime.value = reducedMotion ? 0 : (performance.now() - startTime) * 0.001;
    ...
    // The scene is intentionally created once; prop changes update uniforms below.
